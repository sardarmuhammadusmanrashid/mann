...
const GgetUser=async()=> {
  ...
  <Link className="navbar-brand text-light">Darwin Clinc</Link>
...
<div className="card" >
  <img className="card-img-top" src="https://media.istockphoto.com/photos/doctor-holding-digital-tablet-at-meeting-room-picture-id1189304032?b=1&k=20&m=1189304032&s=612x612&w=0&h=3IlZQ_IDMJDkjPCThsflr8vmCZVPmxXPWLzsxb8rShQ=" alt="Card image cap"/>
  <div className="card-body tt">
    ...
    <button className="btnl btn-outline-danger "><Link href="salma.html" className="text-danger"> find</Link></button>
  </div>
</div>
