...
export default function Delete(){
 ...
 const[status1,setstatus1]=useState("");
    ...
    <input type="text" name="village" value={village} onChange={(e)=>setvillage(e.target.value)} className="form-control"/><br></br>
    </div>
    <div ><label>img</label>
    ...
    <div>
    <input type="submit" value="Delete"  onClick={GgetUser} className="form-control btn btn-danger"/><br></br>
    </div>
